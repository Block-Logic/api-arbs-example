...
while (true) {
  ...
  if (isProfitable) {
    console.log(`uuid: '${uuid}', pair: '${BASE_SYM}_${QUOTE_SYM}', in: ${buyRoute.inAmount / DECIMAL_CUTTER} => ${buyRoute.outAmountWithSlippage / DECIMAL_CUTTER}, out: ${sellRoute.outAmountWithSlippage / DECIMAL_CUTTER}`)
  };
